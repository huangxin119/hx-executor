...
/**
 * 本质上是照抄这个队列LinkedBlockingQueue，去掉了 LinkedBlockingQueue 中 capacity 字段的 final 修饰符，使得队列容量可以动态调整
 */
public class ResizeableCapacityLinkedBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, ResizeableCapacity, java.io.Serializable {
